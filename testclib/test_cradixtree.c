...
void test_radix_tree__iterate(RadixTreeFixture* fix, gconstpointer data){
	...
	CIterator it;
    c_radix_tree_set(tree, "dino", 4, str2);
    c_radix_tree_set(tree, "piano", 5, str4);
    c_radix_tree_set(tree, "dinosaurio", 10, str1);
    c_radix_tree_set(tree, "casa", 4, str3);
    c_radix_tree_iterator_init(tree, &it);
    ostr1 = (char *)c_radix_tree_iterator_next(tree, &it);
    ostr2 = (char *)c_radix_tree_iterator_next(tree, &it);
    ostr3 = (char *)c_radix_tree_iterator_next(tree, &it);
    ostr4 = (char *)c_radix_tree_iterator_next(tree, &it);
    ostr5 = (char *)c_radix_tree_iterator_next(tree, &it);
    c_radix_tree_iterator_dispose(tree, &it);
